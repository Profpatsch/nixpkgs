...
let
  ...
  checkMetaAttr = k: v:
    if metaTypes?${k} then
      if metaTypes.${k}.check v then null else "key '${k}' has a value ${lib.generators.toPretty {} v} of an invalid type ${builtins.typeOf v}; expected ${metaTypes.${k}.description}"
